...
import { assertsLoad,LoadingObj } from '../utils/assetsLoad.js';
...
.circle-rotate0{
  ...
  animation: circleRotate0 2s linear infinite;
}
...
.circle-rotate1{
  transform-origin: center center;
  animation: circleRotate1 2s linear infinite reverse;
}
</style>