<template>
  <div class="fixed inset-0 bg-[rgba(0,0,0,.68)] knowledge-wrap z-50">
    ...
    <span @click="back" class="iconfont absolute top-[5px] right-[5px] cursor-pointer text-white close">&#xe61a;</span>
  </div>
</template>
