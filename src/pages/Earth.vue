...
<script setup>
  ...
  const renderChart = () => {
    const option = {
      backgroundColor: '#000',
      globe: {
        baseTexture: pageType === 'mobile' ? worldTopoBathy200401MObile : worldTopoBathy200401,
        heightTexture: pageType === 'mobile' ? worldTopoBathy200401MObile : worldTopoBathy200401,
        displacementScale: 0.04,
        shading: 'realistic',
        environment: starfield,
        globeRadius: (window.innerWidth > window.innerHeight ? window.innerHeight : window.innerWidth) / 2 *.16,
        realisticMaterial: {
          roughness: 0.9
        },
